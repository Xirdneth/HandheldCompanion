...
/// <summary>
///     Logique d'interaction pour layoutTemplate.Value.xaml
/// </summary>
[JsonObject(MemberSerialization.OptIn)]
public partial class LayoutTemplate : UserControl, IComparable, ILayoutTemplate
{
    ...
    public LayoutTemplate(string name, string description, string author, bool isInternal, Type deviceType = null): this()
    {
    ...
    public LayoutTemplate(Layout layout,
        Lazy<IControllerManager> controllerManager, Lazy<ITimerManager> timerManager) : this()
    {
    ...
    private LayoutTemplate(string name, string description, string author, bool isInternal,
        ...
        Lazy<ITimerManager> timerManager, Type deviceType = null) : this()
    {
        this.controllerManager = controllerManager;
        this.timerManager = timerManager;
        ...
        Layout = new Layout(true, controllerManager, timerManager);
    ...
    [JsonProperty] public Layout Layout { get; set; }
