...
public class AynLoki : IDevice,IIDevice
{
    ...
    public void SetFanControl(bool enable, int mode)
    {
    ...
    public void SetFanDuty(double percent)
    {
    ...
    public bool SetLedColor(Color MainColor, Color SecondaryColor, LEDLevel level, int speed)
    {
    ...
    public string GetGlyph(ButtonFlags button)
    {
        switch (button)
        {
